...
urlpatterns = [
    ...
    path('news/create', PostCreate.as_view(), name='postcreate'),
    path('news/<int:pk>/edit', PostEdit.as_view(), name='postedit'),
    path('news/<int:pk>/delete', PostDelete.as_view(), name='postdelete'),
